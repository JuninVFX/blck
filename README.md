        ...
        if UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled then
            ...
            FeariseToggle.MouseButton1Click:Connect(function()
                for _, guiObject in ipairs(game:GetService("CoreGui"):GetChildren()) do
                    if guiObject.Name == "AuraHub" and guiObject:IsA("ScreenGui") then
            ...
            game:GetService("CoreGui").ChildRemoved:Connect(function(Value)
                if Value.Name == "Aura Hub" then
                    AuraToggle.Parent.Parent:Destroy()
                end
            end)
...
local Window = Fluent:CreateWindow({
    Title = "AuraShop" .. " | ".."BlueLock : Rival".." | ".."[V1]",
    SubTitle = "by JuninVFX",
    TabWidth = 160,
...
do
    ...
    Function_Storage.CreateFeariseHubMobileToggle = function()
		...
		feariseHubMobile.Name = "AuraHubMobile"
...
SaveManager:SetFolder("Aura Hub")
InterfaceManager:SetFolder("Aura Hub")
